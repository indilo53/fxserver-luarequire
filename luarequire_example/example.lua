...
print('i18n test 1')
asserteq(i18n('foo'), 'foo')

print('i18n test 2')
asserteq(i18n('bar'), 'This string is from an external file')

-- PenLight example (test-lexer.lua)
